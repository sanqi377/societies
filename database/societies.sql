...
CREATE TABLE `s_classification`  (
  ...
  `addtime` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '添加时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单表' ROW_FORMAT = COMPACT;
...
CREATE TABLE `s_societies`  (
  ...
  `class_id` int(11) NULL DEFAULT NULL COMMENT '社团分类id',
  `welcome_status` int(1) NULL DEFAULT NULL COMMENT '社团纳新状态',
  `hots` int(20) NULL DEFAULT 0 COMMENT '社团热度',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `s_societies` VALUES (13, 'ds', 'dsd', 2, 22, '2', 1, '22', 4, 0, 0);
...
CREATE TABLE `s_users`  (
  ...
  CONSTRAINT `role` FOREIGN KEY (`role`) REFERENCES `s_role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
