...
CREATE TABLE `s_notice` (
  ...
  CONSTRAINT `college_id_copy_1` FOREIGN KEY (`college_id`) REFERENCES `s_societies` (`id`)
...
CREATE TABLE `s_powers` (
  ...
  `sign` varchar(50) NOT NULL COMMENT '权限标识',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `s_role_powers_tie` (
  ...
  KEY `powers_id` (`powers_id`) USING BTREE,
  CONSTRAINT `powers_id` FOREIGN KEY (`powers_id`) REFERENCES `s_powers` (`id`),
  CONSTRAINT `role_id` FOREIGN KEY (`role_id`) REFERENCES `s_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- Records of s_users
-- ----------------------------
INSERT INTO `s_users` VALUES ('4', 'oCyJb4xF_IpSqyyqn5kEiGG7UxeM', '叁柒', null, 'XX2021', '信息工程系', '123456', '-1', '13333333333', '1');
